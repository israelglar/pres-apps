...
export function StudentCard({ student, onClick, hasAlert = false }: StudentCardProps) {
  ...
  return (
    <button
      ...
      className={`w-full ${theme.backgrounds.white} rounded-xl shadow-sm p-4 hover:shadow-md ${theme.backgrounds.neutralHover} active:bg-gray-100 transition-colors cursor-pointer text-left`}
    >
